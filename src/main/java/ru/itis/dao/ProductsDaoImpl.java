...
public class ProductsDaoImpl implements ProductsDao {
    ...
    @Override
    public ProductsDao addProduct(Product product) throws SQLException {
    ...
    int productAdded = stmt.executeUpdate();
    System.out.println("Product is added");
        return null;
    }

    @Override
    public Product delete(int id) throws SQLException {
        String sql = "DELETE FROM products WHERE id = ?";
        PreparedStatement stmt = c.prepareStatement(sql);
        stmt.setInt(1,id);
        int idDeleted = stmt.executeUpdate();
